...
import RegulatoryAnalyticsView from '../views/RegulatoryAnalyticsView.vue'
...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/analytics', component: RegulatoryAnalyticsView, meta: { requiresAuth: true, roles: ['ADMIN', 'REGULATOR'] } },
